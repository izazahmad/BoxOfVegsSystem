...
namespace BoxOfVegsSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    InsertionServices insert = new InsertionServices();
                    usr.userID = user.Id;
                    usr.firstName = model.FirstName;
                    usr.lastName = model.LastName;
                    insert.insertUserDetails(usr);
                    await SignInManager.SignInAsync(user, isPersistent:false, rememberBrowser:false);
                    //Add user role to the user
                    await this.UserManager.AddToRoleAsync(user.Id, "consumer");
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            string hashPassword = UserManager.PasswordHasher.HashPassword(newPassword);
